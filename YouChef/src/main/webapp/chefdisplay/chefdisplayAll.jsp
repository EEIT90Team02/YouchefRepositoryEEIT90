	...
	<div class="container">
		<div class="row">
		    ...
		    <div class="col-md-9">
				...
				<form action="<c:url value="${request.contextPath}/chefdisplay/chefview.controller" />"	method="post">
		...
		<%-- 					<c:if test="${not empty list}"> --%>
								<c:forEach var="element" items="${list}">
									<tr> 
										<td><a href="<c:url value="${request.contextPath}/chefdisplay/selectChef.controller?c_id=${element.c_id}&t_id=${element.typeBean.t_id}"/>"><img height='150' width='150' src='<c:url value="${request.contextPath}/pages/getImage.controller?id=${element.c_id}" />'></a></td>
