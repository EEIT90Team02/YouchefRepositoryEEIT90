...
//          		alert("both" + selectedSession);
    ...
    function sendChefInfo(){
		c_id = $("#chef option:selected").val();
		temp.length = 0; 
    	...
    	$.get('/YouChef/handleAjaxForChef.controller',{'c_id':c_id,'theMonth':theMonth,'date':date},function(data){
               	 ...
               	 //alert("disabledDays= "+ disabledDays);
...
//     		   "[{"+"misc:"+ "["+ "'" + c_id + "'" + "," + "'" + orderDate + "'" + "," + "'" + selectedSession + "'" + "," + "'" + DateAndTime + "'"+ "," + "'" + dinePlace + "'" + "]},";
    	   ...
    	   //alert(ob);
			 ...
			 $.ajax({
		   url: '/YouChef/AddToTypeCart.controller',
		   type: 'POST',
...
<body class="container" style="color:#eddcd1;">
  ...
  <div class="style">
		...
		<select name="selectChef "id="chef" onchange="sendChefInfo()">
			<option value="" >請選擇</option>
		<c:forEach var="chef" items="${chefs}"  varStatus="status">
