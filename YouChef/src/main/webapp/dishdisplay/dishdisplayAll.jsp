		...
		<div class="row">
		    <div class="col-md-2">
		       <div class="list-group">
				...
				<h3 style="color:#ffffff;">${ob[0].typeBean.t_name}</h3>
...
<!-- 												<a href="#" class="btn btn-round btn-default add-to-cart visible-list">Add to Cart</a> -->
											...
											<div >
												<input type="button" class="btn btn-default" value="立即訂購" onclick="window.open('<c:url value="/typeChefOrder.controller?t_id=${element.typeBean.t_id}"/>', '_blank')">
											</div>
										</div>
								</div>
										</c:forEach>								
